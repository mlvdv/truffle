...
import com.oracle.truffle.api.debug.DebugInstrument;
import com.oracle.truffle.api.debug.DebugInstrument.Callback;
...
public final class DebugInstrumentTest extends AbstractInstrumentationTest {

    private static DebugInstrument debugger;

    public static class TestFrontEnd implements com.oracle.truffle.api.debug.DebugInstrument.DebuggerFrontEnd {
        public void onAttach(DebugInstrument example) {
            DebugInstrumentTest.debugger = example;
        }

        public void onDispose() {
            DebugInstrumentTest.debugger = null;
        }
    }

    @BeforeClass
    public static void installFrontEnd() {
        DebugInstrument.installFrontEnd(TestFrontEnd.class);
    }

    @Before
    public void setupDebugger() throws IOException {
        engine.getInstruments().get(DebugInstrument.ID).setEnabled(true);
    ...
    public void testBreakpoint() throws IOException {
        ...
        debugger.installBreakpoint(1, new Callback() {
            public void halted(DebugInstrument d, EventContext haltedAt) {
    ...
    public void testStepInto() throws IOException {
        ...
        debugger.installBreakpoint(7, new Callback() {
            public void halted(DebugInstrument debugger, EventContext haltedAt) {
