 ...
 */
@Registration(id = DebugInstrument.ID)
public final class DebugInstrument extends TruffleInstrument {

    public static final String ID = "debug-instrument";
    ...
    public void installBreakpoint(int line, final Callback callback) {
        instrumenter.attachListener(SourceSectionFilter.newBuilder().lineIs(line).tagIs("STATEMENT").build(), new Breakpoint(callback));
    }
    ...
    private void ontStatementStep(EventContext context) {
        ...
        if (callback != null) {
            currentStatementCallback = null;
            callback.halted(DebugInstrument.this, context);
        }
    }
    ...
    private void setStepping(boolean stepping) {
        ...
        if (stepping) {
            if (step == null) {
                this.stepping = instrumenter.attachListener(SourceSectionFilter.newBuilder().tagIs("STATEMENT").build(), new Stepping());
            }
        } else {
    ...
    public interface Callback {
        ...
        void halted(DebugInstrument debugger, EventContext haltedAt);
    ...
    public interface DebuggerFrontEnd {
        ...
        void onAttach(DebugInstrument example);
